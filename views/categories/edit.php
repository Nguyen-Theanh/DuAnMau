...
<body>
    ...
    <div class="container mt-5">
        <div class="form-container">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb - 0 text-center"><i class="fas fa-edit">Sửa danh mục</i></h4>
    </div>
        <div class="card-body p-4">
            ...
            <?php endif; ?>
            <form action="index.php?action=updatecategory&id=<?= $category['id'] ?>" method="POST">
                <div class="mb-3">
                    <label class="form-label fw-bold">Id danh mục</label>
                    <input type="text" class="form-control" value="<?= htmlspecialchars($category['id']) ?>" disabled>
                </div>
                <div class="mb-3">
